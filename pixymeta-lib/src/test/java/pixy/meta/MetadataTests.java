...
public class MetadataTests  {
	...
	public void format(StringBuffer result, IMetadataDirectory directory, String indent) {
		...
		if ((tags != null) && (tags.size() > 0)) {
			for (IMetadataTag tag : tags) {
				result.append(indent).append(tag.getName()).append(" : ").append(tag.getValue()).append("\n");
			}
			result.append("\n");
		}
